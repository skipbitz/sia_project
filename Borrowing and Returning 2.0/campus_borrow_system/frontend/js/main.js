...
async function loadPublicEquipment(){
  // ensure this page has the equipment list element before proceeding
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  // only load equipment if equipmentList exists on this page
  if(document.getElementById('equipmentList')) loadPublicEquipment()
  ...
  // forgot-password feature disabled: no handler present
})
